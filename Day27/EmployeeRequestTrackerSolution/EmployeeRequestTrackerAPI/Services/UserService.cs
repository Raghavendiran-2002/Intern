...
namespace EmployeeRequestTrackerAPI.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task<ActivateReturnDTO> Activate(ActivateDTO activateDTO)
        {
            var user = await _userRepo.Get(activateDTO.EmployeeID);
            user.Status = activateDTO.Status;
            await _userRepo.Update(user);
            ActivateReturnDTO activateReturn = new ActivateReturnDTO() { EmployeeID = user.EmployeeId, Status = $"User {activateDTO.Status}" };
