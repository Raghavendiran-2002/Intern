...
namespace PizzaTrackerApi.Context
{
    public class PizzaTrackerContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Pizza>().HasData(new Pizza() { PizzaId = 101, Name = "Dominos", Price = 250, StocksQuantity = 2 }, new Pizza() { PizzaId = 101, Name = "PizzaHut", Price = 150, StocksQuantity = 4 });
